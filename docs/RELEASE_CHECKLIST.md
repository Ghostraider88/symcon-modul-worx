...
| Automatischer Zeitplan, Regenverzögerung, tägliche Arbeitszeitänderung und Sperre | Schreibwege implementiert; Arbeitszeitfeld ist eine unveränderte signierte Abbildung; Legacy-Profilanzeige durch moderne Wertdarstellung ersetzt, Docker-Ansicht noch zu bestätigen; Geräteechos der Einstellungen offen. Firmware-Auto-Update wird capability-geprüft als getrennte bestätigte Variable und Symcon-Schalter angezeigt; der Schalter ändert nur die Cloud-Präferenz, nicht die Firmware selbst. Cloud-Echo-Test in Docker und am Gerät offen. |
