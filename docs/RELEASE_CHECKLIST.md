...
| Aktueller Code-Stand im Testbranch | Build 9 enthält neben dem Abgleich der App-gemeldeten Einstellungen nun englische Symcon-Übersetzungen für Status-/Fehlertexte und die Instanzzusammenfassung. GitHub-Test-, Style- und PHP-8.5-Syntaxprüfungen für Commit `0500cc0` sind erfolgreich. Dieser Build ist noch nicht in Docker installiert. |
