...
| Automatischer Zeitplan, Regenverzögerung, tägliche Arbeitszeitänderung und Sperre | Schreibwege implementiert; Arbeitszeitfeld ist eine unveränderte signierte Abbildung; Docker-RPC bestätigt moderne Wertdarstellung mit Suffix „ %“ und Wert 0. Build 3 zeigte noch das geerbte Profil `WORXMOWER.TimeExtension` auf der Eingabevariable; Build 4 bereinigt die Zuordnung, Live-Rückprüfung und negativer Schreib-Echo bleiben offen; Geräteechos der Einstellungen offen. Firmware-Auto-Update wird capability-geprüft als getrennte bestätigte Variable und Symcon-Schalter angezeigt; der Schalter ändert nur die Cloud-Präferenz, nicht die Firmware selbst. Cloud-Echo-Test in Docker und am Gerät offen. |
| Start, Pause und Heimfahrt | Implementiert; am echten Mäher noch nicht bestätigt |
| Aktueller Modulstand der Docker-Mower-Instanz | Build 3 wurde geladen; Auto-Update-Variablen und Capability-Gating sind vorhanden. Build 4 mit Profilbereinigung nach Branch-Aktualisierung und erneutem Anwenden noch live zu prüfen |
