...
| Aktueller Code-Stand im Testbranch | Build 8 enthält neben der Regenverzögerungsgrenze bis 720 Minuten auch den Abgleich der App-gemeldeten Regenverzögerung, Zeiterweiterung und Sperre mit den Symcon-Eingabewerten. GitHub-Test-, Style- und PHP-8.5-Syntaxprüfungen für den aktuellen Branch-Stand `0729582` sind erfolgreich. Dieser Build ist noch nicht in Docker installiert. |
