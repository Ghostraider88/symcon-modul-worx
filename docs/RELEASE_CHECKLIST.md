...
| Aktueller Code-Stand im Testbranch | Build 10 ergänzt den Rückfall abgelehnter oder nicht bestätigter Sollwerte auf zuletzt bestätigte Gerätezustände. GitHub-Tests, Style- und PHP-8.5-Syntaxprüfung für Commit `4d1f4cd` sind erfolgreich. Build 10 ist noch nicht in Docker installiert. |
