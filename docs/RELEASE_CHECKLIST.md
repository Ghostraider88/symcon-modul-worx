...
| Aktueller Code-Stand im Testbranch | Build 10 ergänzt den Rückfall abgelehnter oder nicht bestätigter Sollwerte auf zuletzt bestätigte Gerätezustände; `a8bb143` ergänzt Regressionstests zur Cloud-/App-Synchronisierung des automatischen Zeitplans. Der Quellstand auf Commit `5b77cb8` besteht im Branch und im Pull Request Tests, Style und PHP-8.5-Syntaxprüfung (2026-09-25, 15:10 UTC). Build 10 ist laut letztem Docker-Leseabgleich noch nicht installiert (dort Build 7). |
