...
| Aktueller Code-Stand im Testbranch | Build 10 ergänzt den Rückfall abgelehnter oder nicht bestätigter Sollwerte auf zuletzt bestätigte Gerätezustände. GitHub-Test-, Style- und PHP-8.5-Syntaxprüfungen für Build 9 waren erfolgreich; Build 10 wartet auf CI und ist noch nicht in Docker installiert. |
